package io.mosip.kernel.smsserviceprovider.nimba.test;
...
import io.mosip.kernel.smsserviceprovider.nimba.SMSServiceProviderBootApplication;
import io.mosip.kernel.smsserviceprovider.nimba.constant.SmsPropertyConstant;
import io.mosip.kernel.smsserviceprovider.nimba.dto.SmsServerResponseDto;
import io.mosip.kernel.smsserviceprovider.nimba.impl.SMSServiceProviderImpl;
...
public class SmsServiceProviderTest {
	...
	public void sendSmsTest() {
		...
		UriComponentsBuilder sms = UriComponentsBuilder.fromHttpUrl(apiUrl)
				...
				.queryParam(SmsPropertyConstant.RECIPIENT_NUMBER.getProperty(), "625739085")
